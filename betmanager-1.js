...
function selectRetoTemplate(k){
  ...
  document.getElementById('reto-sport-row').style.display=t.type==='trivia'?'none':'block';
...
function renderRetoView(){
  ...
  if(r.type==='trivia'){tv.style.display='block';if(!triviaState.questions.length)startTrivia(r.name);}
